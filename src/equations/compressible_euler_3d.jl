...
@inline function v_x(u, equations::CompressibleEulerEquations3D)
    rho, rho_v1, _, _, _ = u
    return rho_v1/rho
end

@inline function v_y(u, equations::CompressibleEulerEquations3D)
    rho, _, rho_v2, _, _ = u
    return rho_v2/rho
end

@inline function v_z(u, equations::CompressibleEulerEquations3D)
    rho, _, _, rho_v3, _ = u
    return rho_v3/rho
end
